...
public class JTable_Cargos_Proyecto extends javax.swing.JFrame {
    ...
    private void consulta() {
        ...
        try {
            ...
            Object[] cargosProyecto = new Object[CANTIDAD_DATOS];
            modelo = (DefaultTableModel) Tabla.getModel();
            
            //INGRESE NOMBRES DATOS TABLA
            while (rs.next()) { 
                cargosProyecto[0] = rs.getInt(NOMBRE_DATO_1);
                cargosProyecto[1] = rs.getString(NOMBRE_DATO_2);
                cargosProyecto[2] = rs.getString(NOMBRE_DATO_3);
                modelo.addRow(cargosProyecto);
            }
