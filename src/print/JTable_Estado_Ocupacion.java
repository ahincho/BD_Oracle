...
public class JTable_Estado_Ocupacion extends javax.swing.JFrame {
    ...
    public JTable_Estado_Ocupacion() {
        initComponents();
        tituloTabla.setText("R13001 - CONTROL DE ESTADOS DE OCUPACION");
    ...
    private void consulta() {
        String sql = "select * from r1z_estado_ocupacion order by EstOcuCod";
                ...
                if (((nombre.equals("")))) {
                    ...
                    if ((carFlaAct == 1)) {
                        try {
                            ...
                            st = conet.createStatement();
                            st.executeUpdate(sql);
                            JOptionPane.showMessageDialog(null, "Estado de Ocupación Actualizado!");
                            limpiarFormulario();
                            desactivarFormulario();
                            limpiarTabla();
                        } catch (Exception e) {
