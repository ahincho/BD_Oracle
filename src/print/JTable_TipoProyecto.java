...
public class JTable_TipoProyecto extends javax.swing.JFrame {
    ...
    public JTable_TipoProyecto() {
        initComponents();
        tituloTabla.setText("P13001 - CONTROL DE TIPO DE PROYECTOS");
    ...
    private void consulta() {
        String sql = "select * from p1z_tipo_proyecto order by TipProCod";
                ...
                if (((nombre.equals("")))) {
                    ...
                    if ((carFlaAct == 1)) {
                        try {
                            ...
                            st = conet.createStatement();
                            st.executeUpdate(sql);
                            JOptionPane.showMessageDialog(null, "Tipo Proyecto Actualizado!");
                            limpiarFormulario();
                            desactivarFormulario();
                            limpiarTabla();
                        } catch (Exception e) {
